...
class SentenceEmbedding(nn.Module):
    ...
    def count_tokens_in_dataset(self, dataset, start_token, end_token):
        total_tokens = 0
        for sentence in dataset:
            tokens = self.tokenize(sentence, start_token, end_token)
...
class Transformer(nn.Module):
    def __init__(self, 
        ...
        super().__init__()
        self.encoder = Encoder(d_model, ffn_hidden, num_heads, drop_prob, num_layers, max_sequence_length, german_to_index, START_TOKEN, END_TOKEN, PADDING_TOKEN)
